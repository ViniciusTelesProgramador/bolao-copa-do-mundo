...
export default function PointsBadge({ points, className = '' }: PointsBadgeProps) {
  ...
  let bgStyles = 'bg-slate-800 text-slate-400 border-slate-700/60';
  let label = '0 pts';

  if (points === 3) {
    bgStyles = 'bg-green-500/10 text-[#22c55e] border-green-500/20';
    label = '3 pts';
  } else if (points === 2) {
    bgStyles = 'bg-amber-500/10 text-amber-400 border-amber-500/20';
    label = '2 pts';
  } else if (points === 1) {
